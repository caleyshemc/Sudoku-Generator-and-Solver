...
FirstPuzzle: 
	...
	.data
AskFirstValue:
	.asciiz "\nEnter a random value between 1000 and 99999\n"
AskSecondValue:
	.asciiz "\nEnter another number between 1000 and 99999.  These will be used to seed the random number generator, so try not to enter the same two numbers you did prior.\n"
AskDifficulty:
